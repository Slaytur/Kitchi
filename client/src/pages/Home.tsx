...
class Home extends React.Component {
    render = (): React.ReactNode => (
        <main className="tw-text-center pg-home">
                ...
                <div className="container tw-justify-around">
                    <div className="splash-left">
                        <div>
                            ...
                            <p className="desc tw-my-4">
                                For all your cooking needs.
                            </p>
                            <div className="tw-text-white">
                                <a
                                    href="/auth/signup"
                                    className="btn btn-lg btn-darken btn-green btn-sign-in tw-me-1"
                                >
                                ...
                                <a
                                    href="/auth/login"
                                    className="btn btn-lg btn-darken btn-green btn-sign-in tw-ms-1"
                                >
                    ...
                    <div className="splash-left tw-float-right">
                        <img
                            title="logo"
                            className="tw-w-[400px] tw-h-full"
                            src={LogoImg}
                        />
                    </div>
                </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 80 1440 250">
                <path
                    fill="#B2D481"
                    fillOpacity="1"
                    d="M0,320L60,298.7C120,277,240,235,360,181.3C480,128,600,64,720,85.3C840,107,960,213,1080,234.7C1200,256,1320,192,1380,160L1440,128L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"
                ></path>
            </svg>
